    ...
    <div ref={ref}>
      <div className="mt-1 relative">
        <button
          ...
          } relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-pointer focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              ...
              <div className="sticky top-0 z-10 bg-white">
                <li className=" text-gray-900 cursor-default select-none relative py-2 px-3">
                  <input
                    ...
                    name="search"
                    autoComplete={'off'}
                    className="focus:ring-blue-500 focus:outline-none focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
