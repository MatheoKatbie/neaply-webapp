      ...
      <div className="min-h-screen" style={{ backgroundColor: '#02000F' }}>
        ...
        <div className="max-w-screen-2xl mx-auto px-3 md:px-4 py-4">
          ...
          <section className="mb-6">
            <div className="h-8 rounded-lg mb-2 animate-pulse" style={{ backgroundColor: 'rgba(64, 66, 77, 0.3)' }} />
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              {Array.from({ length: 10 }).map((_, i) => (
                <div key={i} className="group h-[420px]">
                  <div
                    className="border border-[#9DA2B3]/25 rounded-xl overflow-hidden shadow-lg h-full flex flex-col"
                  ...
                  {getDisplayData().workflows.map((wf) => (
                    <div key={wf.id} className="group flex-shrink-0 w-72">
                      <a
                        ...
                        className="border border-[#9DA2B3]/25 rounded-xl overflow-hidden shadow-lg hover:shadow-xl hover:border-[#9DA2B3]/50 transition-all duration-300 hover:scale-[1.02] h-[420px] flex flex-col"
                        style={{ backgroundColor: 'rgba(64, 66, 77, 0.5)' }}
                      >
              ...
              {fillWorkflows(newestWorkflows, 10).map((wf) => (
                <div key={wf.id} className="group h-full">
                  <a
                    ...
                    className="border border-[#9DA2B3]/15 rounded-xl overflow-hidden shadow-lg hover:shadow-xl hover:border-[#9DA2B3]/30 transition-all duration-300 hover:scale-[1.02] h-[420px] flex flex-col"
                    style={{ backgroundColor: 'rgba(64, 66, 77, 0.25)' }}
                  >
                    {/* Header with custom thumbnail */}
                    <div className="relative h-48 p-3">
