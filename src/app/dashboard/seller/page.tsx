            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-lg text-gray-600">
                        Manage your workflows and track your sales
                    </p>
                </div>
                    ...
                    <TabsContent value="overview" className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold">
                                        {workflows.reduce((sum, w) => sum + w._count.orderItems, 0)}
                                    </div>
                                </CardContent>
                            </Card>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center space-x-2 mt-2">
                                                        ...
                                                        <span className="text-sm text-gray-500">
                                                            {workflow._count.orderItems} sales
                                                        </span>
                                                    </div>
                                                </div>
                            ...
                            <CardContent>
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-500">
                                        We're working on detailed analytics to help you track your workflow performance,
