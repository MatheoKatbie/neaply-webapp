...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#243238] border-t border-[#3E4E55] mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-space-grotesk text-xl font-bold text-white">Neaply</span>
            </div>
            <p className="text-white/80 mb-4 max-w-md">
              <Trans i18nKey="footer.description" />
            </p>
            <div className="flex space-x-4">
              <Button className="bg-transparent border-white/20 text-white hover:bg-white/10 font-space-grotesk" size="sm" asChild>
        ...
        <Separator className="my-8 bg-[#3E4E55]" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link
              href="https://github.com/flowmarket"
              className="text-white/60 hover:text-white transition-colors"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
